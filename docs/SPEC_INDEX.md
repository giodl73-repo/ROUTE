...
| `waves/2026-05-13-terminal-contact-source-acquisition-spine/WAVE.md` | Active execution card for terminal-contact manual/cached source acquisition, proof artifact contracts, and promotion gates | You need the current terminal-contact source-acquisition wave, pulse order, or proof import rules |
