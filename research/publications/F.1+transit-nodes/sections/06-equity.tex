...
This paper recommends that T1 hub transit service receive a designation analogous to Essential Air Service (49 U.S.C. § 41731), which would require new authorization under the Surface Transportation Reauthorization Act. The closest existing authority is 49 U.S.C. § 5311(f) (FTA rural intercity bus program), which funds rural intercity bus connections but does not mandate service frequency or cap fares. Under such a designation, minimum service requirements would include:
\begin{itemize}
