...
\subsubsection*{AB5 Constraint: Mode 2 Is Legally Inoperative in ABC-Test States}

Mode 2 faces a significant legal constraint in California, Massachusetts, and New Jersey under ABC-test independent contractor classification laws (California Labor Code \S~2775, enacted as AB5 and modified by Proposition 22 for certain app-based platforms). Under California's \textit{Dynamex} ABC test (2018), relay drivers performing work ``within the usual course of business'' of the hub operator --- i.e., the core relay service --- cannot qualify as independent contractors. Los Angeles and Sacramento relay hubs, two critical nodes on the NY--LA corridor, are in California. Mode 2 is therefore \textbf{legally inoperative at the most important western hubs}. Mode 1 (W-2 hub employment) is the only legally durable model in ABC-test states and should be the default design; Mode 2 is viable as a supplement only in at-will employment states without analogous IC classification requirements. Any relay marketplace launch plan must route Mode 2 deployment away from California, Massachusetts, and New Jersey until FMCSA rulemaking or federal preemption provides a durable legal basis.
