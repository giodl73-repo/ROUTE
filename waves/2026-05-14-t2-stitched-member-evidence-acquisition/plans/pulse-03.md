...
Register the acquisition docket artifact, close the wave, and commit.
...
- `waves/2026-05-14-t2-stitched-member-evidence-acquisition/`

## Deliverables

- [x] Register optimizer and release manifest rows.
- [x] Write `CLOSE.md`.
- [x] Write role review under `panels/evidence-acquisition/`.
...
- Do not declare stitched-member repair complete from acquisition rows alone.
