...
| International EU Rhine-Alpine parser preflight 001 | Draft | EU parser preflight and output contract define allowed metadata/no-geometry link rows, bounded need rows, source-needed node rows, held targets, evidence labels, and review backlog while holding parsed adapter, fixture replacement, approval, SLA, ROI, construction, validation, public-readiness, and external-readiness claims. |
| International EU Rhine-Alpine parser dry run 001 | Draft | EU dry-run tables are generated from the source pack and contract with metadata, bounded vocabulary, source-needed, held, evidence-label, and pending-role rows; no geometry acceptance, fixture replacement, internal proof, official corridor, approval, SLA, ROI, construction, validation, public-readiness, or external-readiness claim. |
...
| International EU Rhine-Alpine source row validation 001 | Draft | EU source-row validation checks dry-run rows only as bounded metadata/gap/held rows for internal parser inspection while holding source adapter validation, geometry, fixture replacement, approval, SLA, ROI, construction, public-readiness, and external-readiness claims. |
| International EU Rhine-Alpine parity gap 001 | Draft | EU parity gap shows source-pack, parser dry-run, payload probe, and field/row-validation layers are ready, but source-derived link replacement, selected node replacement, target posture, and internal proof remain blocked. |
