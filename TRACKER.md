...
| Source health ledger separates identified URLs from usable ingestion paths | 🔄 partial | `data/t1-source-health.csv` and `route t1-source-health --blockers` show live, blocked, key-gated, account-gated, and archive-needed sources |
