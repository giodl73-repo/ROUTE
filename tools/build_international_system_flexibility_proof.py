...
def main() -> None:
    rows = [
        ...
        },
        {
            ...
            "kernel_step": "source_custody_to_extraction_candidate",
            "observed_variation": "transport ministry, plan, statistics, standards, and port/waterway context can support bounded source-content samples and extraction candidates but not accepted source rows",
            "system_response": "China advances through source pack, payload classification, parser contract, dry run, role review, fixture blocker, geometry policy, source-content sample, and extraction candidates",
            "flexibility_decision": "content_depth_started_source_row_validation_held",
            "evidence_artifacts": "docs/reviews/international-china-source-content-sample-001.md;docs/reviews/international-china-parser-extraction-candidates-001.md",
            "blocked_claims": BLOCKED,
