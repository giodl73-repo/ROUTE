...
status: done
source: data/t2-beck-label-density-policy-acceptance.csv
---
...
Replay accepted T2 Beck label-density policy into explicit blocker-relief rows
...
| Input | Source |
|---|---|
| T2 Beck label-density policy acceptance | `data/t2-beck-label-density-policy-acceptance.csv` |
...
| 02 - Blocker-relief surface | done | `data/t2-beck-label-density-blocker-relief.csv`; CLI gate |
| 03 - Review and close | done | `CLOSE.md`; `panels/relief/review.md`; final gates |

## Done Criteria

- Every accepted label-density policy row has one blocker-relief row.
