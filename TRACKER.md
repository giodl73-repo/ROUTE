...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/game/interstate-tycoon-plan.md` now names G0-G4 gates, the evidence-driven growth loop, promotion ladder, and artifact trail; `docs/game/des-moines-diamond-g0.md` defines the first paper prototype; next step is a playtest score sheet plus Des Moines diamond mismatch investigation |
