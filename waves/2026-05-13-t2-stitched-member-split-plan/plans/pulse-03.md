...
Register the split-plan artifact, close the wave, and commit.
...
- `waves/2026-05-13-t2-stitched-member-split-plan/`

## Deliverables

- [x] Register optimizer and release manifest rows.
- [x] Write `CLOSE.md`.
- [x] Write role review under `panels/split-plan/`.
...
- Do not declare stitched-member repair complete from split rows alone.
