...
status: done
source: data/t2-beck-transfer-complexity-policy-acceptance.csv
---
...
Replay accepted T2 Beck transfer-complexity policy into explicit blocker-relief
rows before any optimizer-ledger replay or final Beck replacement publication.
...
| Input | Source |
|---|---|
| T2 Beck transfer-complexity policy acceptance | `data/t2-beck-transfer-complexity-policy-acceptance.csv` |
...
| 02 - Blocker-relief surface | done | `data/t2-beck-transfer-complexity-blocker-relief.csv`; CLI gate |
| 03 - Review and close | done | `CLOSE.md`; `panels/relief/review.md`; final gates |

## Done Criteria

- Every accepted transfer-complexity policy row has one blocker-relief row.
