...
| International EU Rhine-Alpine parity gap 001 | Draft | EU parity gap shows source-pack, parser dry-run, payload probe, field/row-validation, and port-node source validation layers are ready, but source-derived link replacement, target posture, and internal proof remain blocked. |
