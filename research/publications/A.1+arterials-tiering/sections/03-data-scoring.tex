...
\item \textbf{Lane count and IRI}: also from HPMS 2018. Lane count determines theoretical daily capacity ($\text{lanes} \times 1{,}900 \text{ pcph} \times 24\text{h}$). IRI (International Roughness Index) is the primary pavement quality measure.
