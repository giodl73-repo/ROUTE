...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/game/des-moines-diamond-amendments.md` applies v0.2 rules from blind playtest 001; next step is two more simulated G0 playtests plus `route game scenarios` / `inspect` implementation |
