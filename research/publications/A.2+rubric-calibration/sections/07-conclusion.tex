...
The calibration pass documented here identifies that 3 new dimensions were needed; however, the MODULE.md quantification contract called for $\leq$9 dimensions surviving calibration, and the v1.2 rubric now has 15 dimensions (12 original + 3 new). Dimension retirement --- reducing from 15 to $\leq$12 --- is deferred to the v1.3 calibration cycle once full HPMS data is available for all 50 states.
