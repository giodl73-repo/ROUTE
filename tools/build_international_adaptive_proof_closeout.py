...
def main() -> None:
    rows = [
        ...
        },
        {
            ...
            "proof_lane": "China",
            "depth_level": "adaptive_proof_dry_run_depth_deeper_proof_held",
            "input_artifacts": "docs/reviews/international-china-adaptive-proof-closeout-001.md;data/international-china-adaptive-proof-closeout-001.csv",
            "allowed_claim": "China proves the kernel can reach source custody, payload classification, parser contract, role-reviewed dry-run rows, geometry policy, and blockers without content-depth proof",
            "blocked_claims": BLOCKED,
        ...
        },
        {
            ...
            "allowed_claim": "ROUTE now has a bounded international proof ladder: one Canada depth proof, EU/India/Japan adaptive branches, China dry-run-depth branch, and map breadth fixtures",
            "blocked_claims": BLOCKED,
