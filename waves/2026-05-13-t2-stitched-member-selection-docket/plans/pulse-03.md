...
Register the selection docket artifact, close the wave, and commit.
...
- `waves/2026-05-13-t2-stitched-member-selection-docket/`

## Deliverables

- [x] Register optimizer and release manifest rows.
- [x] Write `CLOSE.md`.
- [x] Write role review under `panels/selection-docket/`.
...
- Do not declare stitched-member repair complete from selection rows alone.
