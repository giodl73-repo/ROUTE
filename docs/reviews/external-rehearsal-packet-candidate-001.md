...
| "What would make this packet usable externally?" | Use the technical venue packet scaffold, source custody preflight, venue role preflight, and validation preflight: name venue, reviewer class, presenter, recorder, source owner, material set, selected custody rows, role rows, prohibited-claim scan, L0, and any required L1/L2 closeout. | pass |
