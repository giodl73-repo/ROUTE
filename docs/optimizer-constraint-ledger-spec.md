...
| Map publication scope | `data/map-publication-scope-decision.csv`, `data/map-publication-readiness.csv`, `data/t4-terminal-access-map-exclusion.csv`, `data/source-snapshot-publication-exclusion.csv`, `data/t2-asset-condition-map-publication-exclusion.csv`, `docs/map-publication-scope.md` |
