...
I-35 & -- & T3 & 12.2 & T3 & 33.8 & \textbf{T1} & Laredo A4=10 + grain C4=10 \\
...
\item A4+B4+C4: I-80 gained 18.5 points from USMCA=9, military=8.5, agricultural=9.0; I-110 gained 5.0 from STRAHNET baseline only (no trade, no ag)
\end{enumerate}
