//! Helper `tier_pavement_funding_evidence_accepted_metadata_artifact_acquisition_rows`.
#[allow(unused_imports)]
use crate::*;

pub(crate) fn tier_pavement_funding_evidence_accepted_metadata_artifact_acquisition_rows(
    ...
    review_rows
        ...
        .map(
            |row| TierPavementFundingEvidenceAcceptedMetadataArtifactAcquisitionRow {
                accepted_metadata_artifact_acquisition_id: format!(
                    "PAVEMENTFUNDINGACCEPTEDMETAACQUIRE-{}",
                    stable_id_fragment(&row.accepted_metadata_attachment_review_id)
                ),
                accepted_metadata_attachment_review_id: row
