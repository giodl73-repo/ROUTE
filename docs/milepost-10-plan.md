...
| 13 | Add optimizer run manifest and gate bundle | ✅ done | `route tier-optimize --all-tiers --gate` emits `data/tier-optimizer-runs.csv` with 24 passing optimizer stages and 2 explicit held-known T2 blockers |
