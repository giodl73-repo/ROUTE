...
\$5.1 billion per year (after demand suppression correction; pre-suppression: \$5.4 billion) --- approximately 82\% of the top-15 total of \$6.2 billion.
...
\midrule
\multicolumn{6}{l}{\textbf{Top-5 total}$^{\dagger}$} & \textbf{5.10} \\
\multicolumn{6}{l}{\textbf{Top-15 total}} & \textbf{6.15} \\
\bottomrule
\end{tabular}
\par\smallskip
\noindent\footnotesize{$^{\dagger}$Total reflects demand suppression adjustment $\phi(d)$; pre-suppression total is \$5.4B (see Section~\ref{sec:sensitivity}).}
\end{table}
...
The central estimate (\$5.1B, after demand suppression correction) is robust to single-parameter perturbation: varying
either the cost rate or frequency alone shifts the total by less than 25\%. The pre-suppression figure is \$5.4B. The
