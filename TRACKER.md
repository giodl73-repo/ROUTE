...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/game/des-moines-diamond-playtest.md` provides the score sheet and `docs/game/des-moines-diamond-playthrough.md` provides a reference aha transcript; next step is Des Moines diamond mismatch investigation plus a blind G0 playtest |
