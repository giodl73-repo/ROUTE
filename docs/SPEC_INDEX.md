...
| `data/tier-pavement-source-gaps.csv` | Bundle-level pavement blocker docket aggregating source-needed or repair-required member segments into source/repair actions | You need to close T1/T2 bundle-review rows caused by missing pavement evidence or rough-road members |
