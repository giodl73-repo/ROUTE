...
| L0 tests cover primitive invariants for max-flow, incident degradation, SLA arithmetic, relay timing, and k-connectivity | 🔄 partial | Incident degradation/restoration and max-flow bottleneck/parallel-path behavior are covered; remaining audit: SLA arithmetic, relay timing, and k-connectivity |
