...
evidence status, role-aware authority, and claim-safe readout export.
...
availability, guarantee service windows, set prices, collect payments, prove
revenue, prove ROI, prove construction readiness, or replace emergency
authority.
