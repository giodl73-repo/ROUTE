...
| Media resources | Draft | Media-safe reference package; gives fact sheet, claim guide, source pointers, caption pattern, and red lines while holding official-plan, construction, SLA, ROI, eligibility, compliance, endorsement, approval, public-readiness, and external-readiness claims. |
