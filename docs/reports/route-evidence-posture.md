...
| Communications rude Q&A repair closeout | Draft | Presenter repairs from rude Q&A drill run 001 are closed for internal rehearsal in the presenter guide; populated stakeholder fixture, venue-specific role review, and L1/L2 readiness remain held. |
...
| Sponsor-to-DOT dry-run packet 001 | Draft | Internal named packet; selects materials, closing ask, role-review holds, and fixture candidate shell while keeping external rehearsal, endorsement, official-plan, construction, SLA, ROI, eligibility, compliance, approval, and public-readiness claims held. |
