#!/usr/bin/env python3
"""Build India source-content row validation for extraction candidates."""
...
OUTPUT = ROOT / "data" / "international-india-source-content-row-validation-001.csv"
...
def main() -> None:
    ...
    for index, candidate in enumerate(read_csv(CANDIDATES), start=1):
        ...
        rows.append(
            {
                "validation_id": f"IND-CONTENT-ROWVAL-{index:03d}",
                ...
                "validation_result": "source_content_candidate_row_matched_not_source_row_validated",
