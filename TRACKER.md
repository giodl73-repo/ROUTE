...
| L0 tests cover primitive invariants for max-flow, incident degradation, SLA arithmetic, relay timing, and k-connectivity | 🔄 partial | Incident degradation/restoration is covered in `route-sim`; remaining audit: max-flow, SLA arithmetic, relay timing, and k-connectivity |
