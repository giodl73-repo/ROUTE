...
status: done
source: data/t2-beck-long-connector-policy.csv
---
...
Accept authored T2 Beck long-connector policy rows before any blocker relief or
final Beck replacement publication.

## Opening Rule

This wave may accept the authored long-connector policy. It may not reduce
...
| Input | Source |
|---|---|
| T2 Beck long-connector policy | `data/t2-beck-long-connector-policy.csv` |
...
| 02 - Acceptance surface | done | `data/t2-beck-long-connector-policy-acceptance.csv`; CLI gate |
| 03 - Review and close | done | `CLOSE.md`; `panels/acceptance/review.md`; final gates |

## Done Criteria

- Every authored long-connector policy row has one acceptance row.
