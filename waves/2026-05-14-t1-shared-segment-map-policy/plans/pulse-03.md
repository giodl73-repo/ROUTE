...
Register the shared-segment map-policy artifact, close the wave, and commit.
...
- `waves/2026-05-14-t1-shared-segment-map-policy/`

## Deliverables

- [x] Register optimizer and release manifest rows.
- [x] Write `CLOSE.md`.
- [x] Write role review under `panels/map-policy/`.
