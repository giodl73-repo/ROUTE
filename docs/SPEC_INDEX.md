...
| `data/game/t2-bundle-overlays.csv` | T2 game/ops overlay binding rows that resolve service-selection rows through the bundle registry or mark bundle binding as pending | You need to see which T2 service levers can safely target bundle ids before incidents, upgrades, restitches, or scenarios use them |
