...
No wave is active. `2026-06-23-milestone-10-t2-regionalizer-qualification-compatibility`
closed after `TierCandidateColumnRow` and `T2RegionalizerRow` gained defaulted
qualification-effect compatibility for future candidate/regionalizer rows.
