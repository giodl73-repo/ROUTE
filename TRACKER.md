...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/game/des-moines-diamond-blind-playtest-001.md` records the first simulated blind-player pass and amendment candidates; next step is an amendment log plus `route game scenarios` / `inspect` implementation |
