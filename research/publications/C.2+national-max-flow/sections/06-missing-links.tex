...
The 18 percent max-flow gain also enables the PTI improvement analyzed in C.1: by removing Dallas and St.\ Louis from the I-69 routing, the PTI for HOU-CHI drops from approximately 1.45 on the current three-hop route to approximately 1.35, which reduces the shipper commitment window from 60--70 hours to approximately 48 hours---the threshold at which a managed-lane SLA becomes commercially viable \citep{ROUTE_C1}. (Note: the 1.8--2.2 PTI range cited in earlier drafts refers to the I-80 Bay Area corridor, not the HOU-CHI three-hop route; C.1 \S05 reports approximately 1.45 for the HOU-CHI baseline.)
...
\end{tabular}
\end{table}
\footnote{Table values assume 1.8\%/yr freight demand growth (FAF4 reference case) compounded over 30 years. The static (no-growth) NPV at 7\% is approximately $-$\$14.7B, reflecting that the I-69 construction cost (\$22B) exceeds the static benefit (\$7.3B PV) when no freight growth is assumed. The investment case depends materially on freight growth assumptions: positive NPV at 7\% requires sustained freight growth $\geq$1.4\%/yr. At the FAF4 central case (1.8\%/yr), NPV is positive under the single-commodity and two-class high scenarios. The static calculation in the NPV bullet list above and the growth-adjusted table values are therefore not contradictory; they reflect different assumptions about the trajectory of freight demand over the project life.}
