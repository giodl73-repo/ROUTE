...
\bar{v} &= \frac{d}{d/v_{\text{cruising}} + N_{\text{stops}} \times t_{\text{stop}}/60} \\
        &\approx 54\text{--}58\text{ mph for corridors } 300\text{--}900\text{ miles}
\end{align}

This effective speed of 54--58 mph still represents a substantial advantage over current
Greyhound operations (mean effective speed approximately 44 mph including stops and layovers)
but is more conservative than a no-stop managed-lane assumption. Travel time values in the
12-corridor comparison table (Section~\ref{sec:travel-time}) reflect this stop-penalty model.
