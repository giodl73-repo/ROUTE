...
| `waves/2026-05-13-great-lakes-terminal-contact-sources/WAVE.md` | Active execution card for turning Great Lakes terminal-contact source-needed rows into source-acquisition and proof dockets | You need the current terminal-contact source wave, pulse order, or source proof rules |
