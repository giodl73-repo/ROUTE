...
\begin{itemize}
  \item \textbf{Track A} established a 16-dimension rubric for corridor classification, identifying 8 T1 Primary Arteries that together carry more than 50\% of national truck ton-miles \citep{ROUTE_A1,ROUTE_A2}.
  ...
  \item \textbf{Track E} designed managed freight lanes for the seven highest-priority T1 corridors: \$121 billion capital, 2.0:1 benefit-cost ratio, with the potential to reduce transcontinental transit time by one full day \citep{ROUTE_E1}.
\end{itemize}
