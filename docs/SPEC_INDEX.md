...
| `waves/2026-05-13-t4-terminal-contact-evidence/WAVE.md` | Active execution card for converting T4 terminal evidence holds into route-to-terminal contact decisions | You need the current terminal-contact evidence wave, pulse order, or scenario-readiness rules |
