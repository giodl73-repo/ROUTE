...
| Source acquisition plan identifies DOT/FHWA systems needed to fill T1/T1 failure evidence fields | ✅ done | `data/t1-failure-source-plan.csv`; official anchors added for Iowa 511, Caltrans PeMS, MassDOT feeds, Bay Area 511, and FHWA NPMRDS/FPM |
