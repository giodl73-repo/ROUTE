...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/INTERSTATE_TYCOON.md` now carries TIGRIS, HUNT, ASPECT, PROSE, SCORE, and QUEST contracts; next step is a G0 Des Moines Diamond paper prototype with screen sketches, evidence cards, project cards, audio cues, and a reproducible season log |
