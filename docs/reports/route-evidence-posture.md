...
| International Canada parser extraction candidates 001 | Draft | Canada parser extraction candidates convert filtered road-graph attributes into separate no-geometry link-candidate rows; no dry-run fixture replacement, source-row validation, geometry acceptance, parsed adapter, official Canadian network, approval, guaranteed SLA, construction, ROI, eligibility, compliance, endorsement, public-readiness, external-readiness, or external validation claim. |
