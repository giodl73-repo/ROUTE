...
Register the candidate scope artifact, close the wave, and commit.

## Deliverables

- [x] Register optimizer and release manifest rows.
- [x] Write `CLOSE.md`.
- [x] Write role review under `panels/candidate-scope/`.
...
- Do not declare stitched-member repair complete from scope review alone.
