...
Register the stitched-member handoff artifact, close the wave, and commit.

## Deliverables

- [x] Register optimizer and release manifest rows.
- [x] Write `CLOSE.md`.
- [x] Write role review under `panels/stitched-registry/`.
...
- Do not declare stitched-member repair complete from handoff alone.
