...
| `waves/2026-05-13-constraint-ledger-blocker-burndown/WAVE.md` | Active execution card for burning down normalized constraint-budget blockers | You need the current blocker-resolution wave, pulse order, and scenario/spec sequencing decision |
