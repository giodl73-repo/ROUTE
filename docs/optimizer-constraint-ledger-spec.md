...
| Source acquisition policy | `data/source-fetch-policy.csv`, evidence-window ledgers, source health ledgers, `data/t4-terminal-access-proof-artifact-attachment.csv`, `data/t4-terminal-access-proof-attachment-review.csv`, `data/t4-terminal-access-proof-artifact-acquisition-targets.csv` |
