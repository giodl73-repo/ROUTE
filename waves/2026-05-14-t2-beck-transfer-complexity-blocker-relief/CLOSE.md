...
# Close - T2 Beck Transfer Complexity Blocker Relief

## Decision

Accepted T2 Beck transfer-complexity policy is now replayed into explicit
blocker-relief rows. Six route rows reduce from one blocker each to zero in
`data/t2-beck-transfer-complexity-blocker-relief.csv`, for a total
`claim_blocker_delta = -6`.

## Evidence

- `data/t2-beck-transfer-complexity-blocker-relief.csv` has six rows.
...
- `proof check docs\SPEC_INDEX.md waves\PHASES.md waves\2026-05-14-t2-beck-transfer-complexity-blocker-relief`
