...
| COMMS-TRACE-001 | TRACE.md / VERIFICATION.md / VALIDATION.md / EVIDENCE.md / REVIEW.md | AUD-002 / AUD-007 | How does a claim move from idea to evidence? | `docs/traces/route-claim-promotion-trace.md` | after claim-promotion package | review steward | proposed |
