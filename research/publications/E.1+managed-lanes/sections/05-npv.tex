...
\midrule
\textbf{Portfolio} & \textbf{11,900} & \textbf{121.0} & \textbf{12.7} & \textbf{115.0} & \textbf{2.3} & \textbf{14} \\
\midrule
...
growth) still returns positive NPV of \$81B. The headline \$115B NPV corresponds to the
high-capacity/central-growth cell; the revised central estimate using Table~\ref{tab:corridor-capacity}
is \$101B. All subsequent conclusions in this paper use the \$101B revised central estimate.
