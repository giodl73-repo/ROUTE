...
| L2 tests run representative scenarios and assert bounded outputs rather than headline-only claims | 🔄 partial | Synthetic T1 closure fixture now bounds baseline, incident, and intervention outputs; next add named NY-LA, Houston-Chicago, and one port corridor fixture |
