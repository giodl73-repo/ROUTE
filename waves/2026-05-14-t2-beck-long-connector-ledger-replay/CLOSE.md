...
# Close - T2 Beck Long Connector Ledger Replay

## Decision

Accepted T2 Beck long-connector relief now reaches the optimizer constraint
...
- `data/optimizer-residual-blocker-backlog.csv` now has five rows and no T2
  `beck_long_connector` backlog family.
- Residual claim blockers dropped from 92 to 89.
...
- `proof check docs\SPEC_INDEX.md waves\PHASES.md waves\2026-05-14-t2-beck-long-connector-ledger-replay`
