...
|---|---|---|
| Three populated source-backed fixtures exist. | They demonstrate process for terminal access, freight parking/rest constraints, and rural/agricultural access lanes, not cross-industry agreement. | Use `docs/reports/industry-stakeholder-source-fixture-campaign.md` to add more fixture packs by lane before stronger claims. |
