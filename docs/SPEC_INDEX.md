...
| `waves/2026-05-13-columbus-south-terminal-contact-proof/WAVE.md` | Active execution card for the Columbus South terminal-contact proof pilot | You need the current Columbus source-proof wave, pulse order, or proof promotion rules |
