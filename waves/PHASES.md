...
| 2026-05-13 | Constraint Ledger Blocker Burn-Down | Turn normalized constraint-budget blockers into explicit decisions, starting with the I-84 hard blocker and T4 zone-assignment backlog. | active |

## Next Active Wave

`2026-05-13-constraint-ledger-blocker-burndown` is active.
