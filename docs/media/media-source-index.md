...
| Canada parser dry-run gate | ROUTE can mechanically check the generated Canada dry-run fixture for contract columns, labels, source limits, evidence coverage, and review backlog. | `docs/reviews/international-canada-parser-dry-run-gate-001.md`; `tools/check_canada_parser_dry_run.py`; `docs/reviews/international-canada-parser-dry-run-generator-001.md` | dry-run gate passes / source payload validation held | source payload validation, parsed adapter, fixture replacement, official Canadian network, Transport Canada/provincial/port approval, route designation, guaranteed SLA, construction readiness, ROI, eligibility, compliance, endorsement, external validation, public readiness, or external readiness |
