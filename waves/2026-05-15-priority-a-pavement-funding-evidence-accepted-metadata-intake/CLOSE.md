...
# Priority A Pavement Funding Evidence Accepted Metadata Intake Close

## Decision

Priority-A pavement funding evidence accepted metadata source-access rows now
have explicit artifact intake requirements. No accepted artifact is cached,
...
- `cargo fmt -p route`
- `cargo test -p route`
- `cargo run -q -p route -- tier-pavement-funding-evidence-accepted-metadata-intake --gate`
...
- `C:\src\target\debug\proof check docs\SPEC_INDEX.md docs\optimizer-constraint-ledger-spec.md waves\PHASES.md waves\2026-05-15-priority-a-pavement-funding-evidence-accepted-metadata-intake`
- `powershell -ExecutionPolicy Bypass -File scripts\check-mileposts.ps1 -SkipTests`

## Residual Holds

- Accepted metadata source-capture placeholders must still be recorded before
  artifact attachment, evidence acceptance, or asset-condition relief replay.
