...
| Industry/stakeholder source fixture campaign | Draft | Executable fixture backlog for freight, rural/agriculture, state DOT, community/environmental, non-driving access, resilience, ROI/cost, and technical rehearsal lanes; only STAKE-FIX-001 is populated, and validation/endorsement claims remain held. |
