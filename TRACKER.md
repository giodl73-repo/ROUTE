...
| Adversity scenario library covers T1/T1 closure, corridor segment closure, port surge, weather/flood disruption, relay hub outage, EV/rest-area outage, and managed-lane sensitivity | 🔄 partial | `route pressure-scenarios --gate-l2` now verifies required adversity-class coverage; relay hub and EV/rest-area outage rows are cataloged but still Planned |
