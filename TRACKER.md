...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/game/des-moines-diamond-panel-g0.md` grants G0-B pass and G1-A start; G0-C remains held for a human blind playtest or owner acceptance of simulated evidence; next step is `route game scenarios` / `inspect` implementation |
