...
The transit integration layer adds \$2 billion to the I2.0 program --- 0.8\% of total capital --- and unlocks 9 T1/T1 diamond hubs and approximately 50 T1/T2 regional stops for intercity bus service. This section summarizes the transit case; the full analysis appears in the companion F.1 paper \citep{ROUTE_F1}.
...
The C3 alignment finding --- a correlation of $r = 0.68$ between C3 (Economic Opportunity Access) score and transit-dependent household density at hub locations \citep{ROUTE_F1} --- suggests that the I2.0 equity benefit is concentrated in precisely the corridors already identified as economic opportunity priorities by the ROUTE rubric.
