...
| L0 tests cover primitive invariants for max-flow, incident degradation, SLA arithmetic, relay timing, and k-connectivity | 🔄 partial | Incident degradation/restoration, max-flow bottleneck/parallel-path behavior, relay spacing/driver-mode behavior, and SLA arithmetic are covered; remaining audit: k-connectivity |
