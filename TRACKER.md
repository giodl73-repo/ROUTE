...
| Interstate Tycoon turns pressure-test proof into a playable standard-by-standard demo | 🔄 partial | `docs/game/des-moines-diamond-playtest.md` now provides the G0 score sheet, season log, aha check, surprise log, and promotion checklist; next step is a narrated playthrough plus Des Moines diamond mismatch investigation |
